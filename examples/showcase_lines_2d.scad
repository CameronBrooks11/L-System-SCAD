...
selected_curve = "moore_square"; // [dragon_curve, dragon_curve_pentagonal, dragon_curve_hexagonal, twin_dragon, terdragon, hilbert_curve, moore_square, peano_curve, gosper_curve, levy_c_curve, koch_curve, koch_curve_animated, quadratic_type1_koch, quadratic_type2_koch, quadratic_fractal1, quadratic_fractal2, quadratic_fractal3, sierpinski_triangle, sierpinski_arrowhead, island_curve, penrose_tiling, pentadendrite, icy, tree, round_star, fractal_plant, minkowski_curve, vicsek_fractal, koch_island, fractal_vine, spiral_curve, hexagonal_spiral, square_fractal, segment_curve, cesaro_sweep, cesaro_carpet, icy_fractal, heighways_dragon, polya_sweep, hexagonal_dragon, hexagonal_dragon_estrela, inverted_terdragon, mandelbrot_quartet, inner_flip_gosper_curve, gosper_curve_tree, gosper_hex, quadratic_gosper, gosper_variation, koch_snowflake_inverted, reflected_koch, sierpinski_arrowhead_hexagon, sierpinski_arrowhead_star, lace, lace_triangle, peano_round_corners, krishna, carpet3, carpet5, pentaplexity, mcworters_pentigree, x_border_cross_curves, moore_curve, pajarita, four_point_stars, cross2, cross3, mango_leaf, maple_leaf, maple_leaf2, rose_triangles, hexagons, hexagon_star, triangles_var3, triangles_var4, dragon_root, pinched_dragon_root, crazy_dragon, pine_dragon, trefoil_knots, brain_dragon, triangular_grid, triangles_var5, octagons, triangles_var1, triangles_var2, peano_gosper, gosper_tri, dragon_lobes, carpet6, peano_variation1]
